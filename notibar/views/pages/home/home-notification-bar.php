...
<div class="njt-nofi-container" >
  <div class="njt-nofi-notification-bar njt-nofi-bgcolor-notification" 
       ...
       aria-live="polite"
       aria-atomic="true"
       style="<?php echo('background:'.esc_attr($bgColorNotification)) ?>">
    <div class="njt-nofi-content njt-nofi-text-color njt-nofi-align-content njt-nofi-content-deskop <?php echo ($classDeskop)?>" style="width:<?php echo esc_attr($contentWidth) ?>">
      ...
      <div class="njt-nofi-button njt-nofi-padding-text " style="<?php if(!$isDisplayButton) { echo ('display: none');}?>">
          <a <?php if($isNewWindown) {echo ("target='_blank' rel='noopener noreferrer'");}?>  
             href="<?php echo esc_url($buttonUrl)?>" 
             class="njt-nofi-button-text njt-nofi-padding-text" 
             aria-label="<?php echo empty(trim($buttonText)) ? esc_attr__('Learn more about this notification', 'notibar') : esc_attr(strip_tags($buttonText)); ?>"
             style="<?php if($isDisplayButton) { echo ('background:' .esc_attr($lbColorNotification).';border-radius:3px;font-weight:'.esc_attr($buttonFontWeight));}?>">
            <?php echo esc_html($buttonText ? $buttonText : __('Learn more', 'notibar'))?>
          </a>
      </div> 
    </div>
    ...
    <div class="njt-nofi-content njt-nofi-text-color njt-nofi-align-content njt-display-none njt-nofi-content-mobile <?php echo ($classMobile)?>" style="width:<?php echo esc_attr($contentWidth) ?>">
      ...
      <div class="njt-nofi-button njt-nofi-padding-text " style="<?php if(!$isDisplayButtonMobile) { echo ('display: none');}?>">
          <a <?php if($isNewWindownMobile) {echo ("target='_blank' rel='noopener noreferrer'");}?>  
             href="<?php echo esc_url($buttonUrlMobile)?>" 
             class="njt-nofi-button-text njt-nofi-padding-text" 
             aria-label="<?php echo empty(trim($buttonTextMobile)) ? esc_attr__('Learn more about this notification', 'notibar') : esc_attr(strip_tags($buttonTextMobile)); ?>"
             style="<?php if($isDisplayButtonMobile) { echo ('background:' .esc_attr($lbColorNotification).';border-radius:3px;font-weight:'.esc_attr($buttonFontWeightMobile));}?>">
            <?php echo esc_html($buttonTextMobile ? $buttonTextMobile : __('Learn more', 'notibar'))?>
          </a>
      </div>
    </div>
    ...
    <div class="njt-nofi-toggle-button njt-nofi-hide njt-nofi-text-color njt-nofi-hide-admin-custom" 
     role="button" 
     tabindex="0" 
     aria-label="<?php echo esc_attr__('Toggle notification bar', 'notibar'); ?>"
    ...
    <div class="njt-nofi-close-button njt-nofi-hide njt-nofi-text-color njt-nofi-hide-admin-custom" 
     role="button" 
     tabindex="0" 
     aria-label="<?php echo esc_attr__('Close notification bar', 'notibar'); ?>"
     style="cursor: pointer;">
      <span class="njt-nofi-close-icon-container">
        <svg class="njt-nofi-close-icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" version="1.1" width="512" height="512" x="0" y="0" viewBox="0 0 386.667 386.667" style="enable-background:new 0 0 512 512" xml:space="preserve"><g><path xmlns="http://www.w3.org/2000/svg" d="m386.667 45.564-45.564-45.564-147.77 147.769-147.769-147.769-45.564 45.564 147.769 147.769-147.769 147.77 45.564 45.564 147.769-147.769 147.769 147.769 45.564-45.564-147.768-147.77z" fill="#ffffff" data-original="#000000" style="" class=""/></g></svg>
      </span>
  ...
  <div>
    <div class="njt-nofi-display-toggle njt-nofi-text-color njt-nofi-bgcolor-notification" 
     role="button" 
     tabindex="0" 
     aria-label="<?php echo esc_attr__('Show notification bar', 'notibar'); ?>"
     style="<?php echo('background:'.esc_attr($bgColorNotification)) ?>; cursor: pointer;">
      <span class="njt-nofi-close-icon-container">
